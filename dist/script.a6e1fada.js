...
},{}],"../../../.nvm/versions/node/v10.21.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"hey-listen":"node_modules/hey-listen/dist/hey-listen.es.js","process":"../../../.nvm/versions/node/v10.21.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/@popmotion/easing/dist/easing.es.js":[function(require,module,exports) {
"use strict";
...
var isSelected = document.getElementById("main"); // const dimensions = document.getElementsByClassName("dimensions");
...
function timmer() {
  setTimeout(function () {
    readyToPlay = true;
  }, 15000); // console.log("FIRE");
}

function changePage(e) {
  var pw = e.target.value.toLowerCase();

  if (pw === "d&d" || pw === "dnd" || pw === "dungeons and dragons" || pw === "dungeons & dragons") {
    ...
    if (!readyToPlay) {
      ...
      var playPromise = document.querySelector("audio").play(); // playPromise();
    }
...
var ball = document.querySelector(".grab");
...
var nameStyler = (0, _popmotion.styler)(name);
var nameXY = (0, _popmotion.value)({
  x: 0,
  y: 0
}, nameStyler.set);
(0, _popmotion.listen)(name, "mousedown touchstart").start(function (e) {
  e.preventDefault();
  (0, _popmotion.pointer)(nameXY.get()).start(nameXY);
});
(0, _popmotion.listen)(document, "mouseup touchend").start(function () {
  (0, _popmotion.spring)({
    from: nameXY.get(),
...
},{"popmotion":"node_modules/popmotion/dist/popmotion.es.js"}],"../../../.nvm/versions/node/v10.21.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.nvm/versions/node/v10.21.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/script.js"], null)
